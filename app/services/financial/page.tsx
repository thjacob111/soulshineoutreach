  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="bg-gradient-to-b from-slate-600 to-slate-700 text-white text-center py-20 px-6">
        <h1 className="text-4xl font-black mb-3">Financial Services</h1>
        <p className="text-gray-300 max-w-xl mx-auto">Guidance on financial wellness, budgeting, and connecting you with trusted local financial resources.</p>
      </section>
