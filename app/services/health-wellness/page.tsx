  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="bg-gradient-to-b from-slate-600 to-slate-700 text-white text-center py-20 px-6">
        <h1 className="text-4xl font-black mb-3">Health & Wellness</h1>
        <p className="text-gray-300 max-w-xl mx-auto">Personalized support for diet, exercise, sleep, and mindfulness to help you build lasting balance.</p>
      </section>
